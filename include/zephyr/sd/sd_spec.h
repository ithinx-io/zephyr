...
#define SDIO_CMD_ARG_RW_SHIFT (31U)		/*!< read/write flag shift */
#define SDIO_CMD_ARG_FUNC_NUM_SHIFT (28U)	/*!< function number shift */
#define SDIO_DIRECT_CMD_ARG_RAW_SHIFT (27U)	/*!< direct raw flag shift */
#define SDIO_CMD_ARG_REG_ADDR_SHIFT (9U)	/*!< direct reg addr shift */
#define SDIO_CMD_ARG_REG_ADDR_MASK (0x1FFFFU)	/*!< direct reg addr mask */
#define SDIO_DIRECT_CMD_DATA_MASK (0xFFU)	/*!< data mask */

#define SDIO_EXTEND_CMD_ARG_BLK_SHIFT (27U)	/*!< extended write block mode */
#define SDIO_EXTEND_CMD_ARG_OP_CODE_SHIFT (26U)	/*!< op code (increment address) */
...
#define SDIO_MAX_IO_NUMS (7U) /*!< Maximum number of I/O functions for SDIO */

#define SDIO_TPL_CODE_NULL (0x00) /*!< NULL CIS tuple code */
#define SDIO_TPL_CODE_MANIFID (0x20U) /*!< manufacturer ID CIS tuple code */
#define SDIO_TPL_CODE_FUNCID (0x21U) /*!< function ID CIS tuple code */
#define SDIO_TPL_CODE_FUNCE (0x22U) /*!< function extension CIS tuple code */
