...
ZTEST_USER_F(bq27z746, test_get_props__returns_ok)
{
	...
	zassert_equal(props[0].value.avg_current, -1000);
	zassert_equal(props[1].value.cycle_count, 1);
	zassert_equal(props[2].value.current, -1000);
	...
	zassert_equal(props[11].value.sbs_at_rate, -1);
	...
	zassert_between_inclusive(props[1].value.cycle_count, 0, 65535);
